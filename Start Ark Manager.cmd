...
if defined SILENT (
  powershell -WindowStyle Hidden -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0Start-ArkManager.ps1" -NoBrowser %*
) else (
